    ...
    components: [
      ...
      },
      {
        ...
        components: [
          {
            type: 10,
            content: '## <:usdt:1507676670654419064> • Request USDT\n## [BEP-20] • <:usdt:1507676670654419064>\n• Network: **BSC (BEP-20)**'
          },
          {
            type: 1,
            components: [
  ...
  components: [
    ...
    if (interaction.isModalSubmit()) {
      ...
      if (interaction.customId.startsWith('usd_modal_')) {
        ...
        const usdConfirmEmbed = new EmbedBuilder().setDescription(`## <a:loading:1507682188228034586> • USD amount set to\n## \`$${usdAmount.toFixed(2)}\`\nPlease confirm the USD amount.`).setColor(0x2b2d31);
